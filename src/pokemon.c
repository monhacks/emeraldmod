...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(SHELLOS_E),
    SPECIES_TO_HOENN(GASTRODON_E),
    SPECIES_TO_HOENN(SHELLOS_W),
    SPECIES_TO_HOENN(GASTRODON_W),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(SHELLOS_E),
    SPECIES_TO_NATIONAL(GASTRODON_E),
    SPECIES_TO_NATIONAL(SHELLOS_W),
    SPECIES_TO_NATIONAL(GASTRODON_W),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(SHELLOS_E),
    HOENN_TO_NATIONAL(GASTRODON_E),
    HOENN_TO_NATIONAL(SHELLOS_W),
    HOENN_TO_NATIONAL(GASTRODON_W),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_SHELLOS_E - 1]   = ANIM_V_STRETCH,
    [SPECIES_GASTRODON_E - 1] = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_SHELLOS_W - 1]   = ANIM_V_STRETCH,
    [SPECIES_GASTRODON_W - 1] = ANIM_CIRCULAR_STRETCH_TWICE,
...
static const u16 sSlicingMovesTable[] =
{
    ...
    MOVE_SLASH, MOVE_X_SCISSOR, MOVE_PSYCHO_CUT, MOVE_AIR_SLASH, MOVE_RAZOR_WIND,
    SLICING_MOVES_END
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (WEATHER_HAS_EFFECT2) 
    {
        ...
        {
            // Hail boost Defense by 50% to Ice-type Pokémon
            if (IS_BATTLER_OF_TYPE(defender->species, TYPE_ICE))
                defense = (150 * defense) / 100;
        }
        ...
        if (gBattleWeather & B_WEATHER_SANDSTORM)
        {
            ...
            // Sand Force
            if (attacker->ability == ABILITY_SAND_FORCE && (type == TYPE_GROUND || type == TYPE_STEEL || type == TYPE_ROCK))
                gBattleMovePower = (130 * gBattleMovePower) / 100;
        }
