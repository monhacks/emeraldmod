...
static const u8 sSwarmDescription[] = _("Boost the power BUG moves.");
...
static const u8 sStrongJawDescription[] = _("Ups biting move power.");
...
static const u8 sPranksterDescription[] = _("Prioritize status moves.");
...
static const u8 sAmplifyDescription[] = _("Boost sound-base moves.");
...
static const u8 sHydropowerDescription[] = _("Gain STAB on Water-type move.");
